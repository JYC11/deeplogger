...
void main() {
  ...
  img.fillCircle(image, x: 512, y: 512, radius: 360, color: img.ColorRgb8(0xFF, 0xFF, 0xFF));
  img.fillCircle(image, x: 512, y: 512, radius: 200, color: img.ColorRgb8(0x00, 0x83, 0x8F));
